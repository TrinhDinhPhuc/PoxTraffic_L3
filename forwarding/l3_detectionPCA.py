...
class l3_switch (EventMixin):
  ...
  def _handle_openflow_PacketIn (self, event):
    ...
    if isinstance(packet.next, ipv4):
      ...
      # print("packet check_sum: ",packet.next.checksum)
      # print("packet pack: ",packet.next.pack)
      # print("packet ttl: ",packet.next.ttl)

      #print("packet: ", dir(packet.next), "packet_type = ",packet.type,"packet_src = ",packet.src, "packet_raw = ",packet.next )
      ...
      if(initialCount>5):
      	if(-1 < pca_obj.getYDist() < 1 and ddosStart ==False) :
      		...
      		startPCA =time.time()
       		...
       		if(ddosPCACount > 800 and (endPCA - startPCA)<20):
